...
const statusItems = [
  ...
  { label: "B站", value: "内容同步更新" },
  { label: "课程", value: "章节化公开发布" },
  { label: "日报 Agent", value: "Git 自动推送" },
] as const;
    ...
    <section className="border-b border-line">
      <div className="py-14 md:py-20">
        ...
        <h1 className="mt-6 max-w-5xl font-serif text-[2.9rem] leading-[0.96] font-semibold tracking-[-0.05em] md:text-[5.4rem]">
          把 AI 内容、课程、日报与项目，收拢到一个持续更新的中文站点。
        </h1>
        <p className="mt-6 max-w-3xl text-[15px] leading-8 text-muted md:text-lg">
          这里集中维护 Jaguar 的文章、AI 日报、公开课程与开源项目，也为后续的 AI Lab 预留空间。
        </p>
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          {pillars.map((pillar) => (
            ...
            >
              ...
              <h2 className="mt-5 font-serif text-[2rem] font-semibold tracking-tight">
                {pillar.label}
              </h2>
