...
export const metadata: Metadata = {
  title: "Lab",
  description: "JaguarAI Lab roadmap.",
};

export default async function LabPage() {
  const page = await getSitePageBySlug("lab");
  ...
  return (
    <Container className="py-14 md:py-20">
      <header className="max-w-4xl">
        <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-muted">Reserved Exploration Area</p>
